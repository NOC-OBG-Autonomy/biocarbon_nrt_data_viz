...
create_kml_line(data, 'C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/unit_345_traj.kml', simplekml.Color.purple)

#Unit 397
print(f"Unit 397 traj updating...")
data = get_positions(config.token, 'slocum', 'unit_397')
create_kml_line(data, 'C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/unit_397_traj.kml', simplekml.Color.orange)

#Unit 398
print(f"Unit 398 traj updating...")
data = get_positions(config.token, 'slocum', 'unit_398')
create_kml_line(data, 'C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/unit_398_traj.kml', simplekml.Color.green)


#unit 405
print(f"Unit 405 traj updating...")
data = get_positions(config.token, 'slocum', 'unit_405')
create_kml_line(data, 'C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/unit_405_traj.kml', simplekml.Color.blue)
...
create_kml_point(gliders, lon_list, lat_list, u_list, v_list, 'C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/last_pos.kml')
...
plt.savefig('C:/Users/hanshil/OneDrive - NOC/Desktop/DY180_NRT_plots/Google Earth Files/py_kml output/gliders_dac.png', transparent = True)
plt.clf()
plt.close()
